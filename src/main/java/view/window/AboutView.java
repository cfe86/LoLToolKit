...
public class AboutView extends JFrame {
	...
	private JLabel lastFastUpdateJL;
	private JLabel lastFastUpdateTextJL;
	private JLabel developedJL;
	private JLabel developedTextJL;
	private JLabel riotJL;
	 ...
	 */
	public AboutView() {
		mls = new MLS("languagefiles/AboutView", Config.getInstance().getCurrentLanguage());
	...
	public void init() {
		...
		lastFastUpdateJL = mls.generateJLabel("lastFastUpdateJL");
		lastFastUpdateTextJL = mls.generateJLabel("lastFastUpdateTextJL");
		lastFastUpdateTextJL.setText(lastFastUpdateTextJL.getText().replace("{0}", Config.getInstance().getLastUpdateDate()));
		developedJL = mls.generateJLabel("developedJL");
		developedTextJL = mls.generateJLabel("developedTextJL");
		riotJL = mls.generateJLabel("riotJL");
		copyrightJL = mls.generateJLabel("copyrightJL");

		setContentPane(contentPane);

		JPanel panelP = new JPanel(new MigLayout("insets 5", "[shrink][grow]", "[shrink][shrink][shrink][shrink][shrink][shrink][shrink]"));
		...
		panelP.add(lastFastUpdateJL, "gaptop 5");
		panelP.add(lastFastUpdateTextJL, "grow, gaptop 5, wrap, gapleft 10");

		
		panelP.add(riotJL, "grow, span 2, wrap, gaptop 40");
		panelP.add(copyrightJL, "span 2, grow");
