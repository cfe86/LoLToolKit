...
import controller.ChampionNoteController;
import controller.SmartcastController;
...
public class TabManager {
	...
	private TabManager() {
		...
		// *********************
		// first tab
		register("smartcastTab", new SmartcastPanel(), new SmartcastController(), new String[] { "champinfoTab", "Main" });
		// second tab
		register("champinfoTab", new ChampNotePanel(), new ChampionNoteController(), new String[] {});
	...
	/**
	 * gets a map with all controllers where the identifier maps to the controller, for the main controller
	 * 
